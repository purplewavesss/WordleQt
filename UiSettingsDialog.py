...
class UiSettingsDialog(object):
    def setup_ui(self, settings_dialog):
        ...
        self.hard_mode_on_option.setGeometry(QtCore.QRect(10, 20, 95, 20))
        self.hard_mode_on_option.setObjectName("hard_mode_on_option")
        ...
        self.hard_mode_off_option.setChecked(True)
        self.hard_mode_off_option.setObjectName("hard_mode_off_option")
        ...
        self.light_mode_option.setGeometry(QtCore.QRect(10, 20, 95, 20))
        ...
        self.reset_streak_button.setGeometry(QtCore.QRect(10, 20, 91, 51))
